<div class="about-section">
    @if ($about)
        ...
        @if ($about->introduction)
            <div class="introduction">{!! strip_tags(
                $about->introduction,
                '<p><br><strong><em>
                                                                <ul>
                                                                    <ol>
        ...
        @if ($about->mission)
            <div class="mission">
                <h4>Our Mission</h4>
                <div class="mission-content">{!! strip_tags(
                    $about->mission,
                    '<p><br><strong><em>
                                                                                <ul>
                                                                                    <ol>
    ...
    @else
        ...
        <p>We are dedicated to producing high-quality farm products using sustainable methods. Our family-owned farm has
            been operating since 2010, providing the freshest produce to our community.</p>
        <div class="about-cta">
