        ...
        <div class="filter-options">
            <div class="filter-group">
                ...
                <div class="price-range">
                    <input type="range" min="0" max="10000" step="100" value="5000" id="priceRange">
                    <div class="range-labels">
                        <span>KSh 0</span>
                        <span id="priceValue">KSh 5,000</span>
...
.product-details h2 {
    ...
    color: var(--dark-color);
    line-height: 1.3;
    min-height: 2.6rem; /* Consistent height for titles */
}
...
@media (max-width: 480px) {
    ...
    .filter-toggle, .sort-options select {
        width: 100%;
    }
