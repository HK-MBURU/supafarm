                ...
                <div class="card bg-success text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="mb-0">
                                    {{ $activeProducts ?? App\Models\Product::where('is_active', true)->count() }}</h4>
                ...
                <div class="card bg-warning text-dark">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="mb-0">
                                    {{ $featuredProducts ?? App\Models\Product::where('is_featured', true)->count() }}</h4>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mb-3">
                                @if ($product->sale_price)
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        <span
                                            class="h5 mb-0 text-success fw-bold">{{ $product->formatted_sale_price }}</span>
                                        <small
                                            class="text-muted text-decoration-line-through">{{ $product->formatted_price }}</small>
                                        <span class="badge bg-danger">Save {{ $product->discount_percentage }}%</span>
                                    </div>
                                @else
                                    <span class="h5 mb-0 fw-bold text-dark">{{ $product->formatted_price }}</span>
                                @endif
                            </div>
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <!-- Featured Toggle -->
                                    <form action="{{ route('admin.products.toggleFeatured', $product->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit"
                                            ...
                                            <i
                                                class="fas fa-star {{ $product->is_featured ? 'text-white' : 'text-warning' }}"></i>
                                        </button>
                                    </form>
                                </div>
