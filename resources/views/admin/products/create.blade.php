...
@section('content')
                    ...
                    <div class="form-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-input @error('category_id') error @enderror" id="category_id"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-textarea @error('description') error @enderror" id="description" name="description" rows="5"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-textarea @error('features') error @enderror" id="features" name="features" rows="4"
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-prefix">KSh</span>
                                        <input type="number" class="form-input @error('sale_price') error @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-input @error('stock') error @enderror" id="stock"
                                    name="stock" value="{{ old('stock', 0) }}" placeholder="0" min="0"
                                    required>
                                @error('stock')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                    ...
                    <div class="form-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input @error('meta_title') error @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-textarea @error('meta_description') error @enderror" id="meta_description"
                                    name="meta_description" rows="3" placeholder="SEO meta description">{{ old('meta_description') }}</textarea>
                ...
                <div class="sidebar-column">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="image-upload-area" id="imageUploadArea">
                                    <input type="file" class="image-input" id="images" name="images[]"
                    ...
                    <div class="form-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group-switch">
                                <div class="switch-wrapper">
                                    <input type="checkbox" class="switch-input" id="is_featured" name="is_featured"
    ...
    <style>
        ...
        /* Fix Button Colors - Add these to your existing styles */
        ...
        /* Primary Button - Make sure it's visible */
        .btn-primary {
            background-color: #BC450D !important;
            color: #ffffff !important;
            border: 1px solid #BC450D !important;
        }

        .btn-primary:hover {
            background-color: #541907 !important;
            border-color: #541907 !important;
        }
        ...
        /* Switch - Make sure it's visible when checked */
        .switch-input:checked+.switch-label {
            background-color: #BC450D !important;
        }
        ...
        form.addEventListener('submit', function(e) {
            ...
            requiredFields.forEach(field => {
                ...
                if (input && !input.value.trim()) {
                    errorMessages.push(`Please fill in ${field.replace('_', ' ')}`);
                    hasErrors = true;
                }
            });
